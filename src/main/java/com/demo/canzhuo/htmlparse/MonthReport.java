...
public class MonthReport {
    ...
    private void getMonthData() throws IOException {
        File dir = new File("/Users/micx/Projects/canzhuo/month/filterData");
        File[] files = dir.listFiles();

        FileWriter fw = new FileWriter("/Users/micx/Projects/canzhuo/monthReport");

        fw.write("商户\t日期\t订单数量\t订单金额\t菜品费\t折后菜品费\t制餐费\t餐盒费\t应付餐厅\t实付餐厅\t收派送费\n");
        for(int i=0;i<files.length;i++){
            FileReader reader = new FileReader("/Users/micx/Projects/canzhuo/month/filterData/"+files[i].getName());
            BufferedReader br = new BufferedReader(reader);
    ...
    public static void main(String[] args) throws IOException, SAXException, ParserException {
        MonthReport dailyReport = new MonthReport();
        dailyReport.handleStoreID();
        dailyReport.getMonthData();
    }
}
