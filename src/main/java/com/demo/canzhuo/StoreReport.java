...
//        }
    ...
    private void showMembers() throws Exception {
        FileWriter fw = new FileWriter("/Users/micx/Projects/canzhuo/store");
        for(int i=1; i<=43; ++i) {
            fw.write(request("http://admin.canzhuowang.cn/admin.php/store/admin?Store_page="+i));
    ...
    public static void main(String[] args) throws Exception {
        StoreReport hacker = new StoreReport();
        hacker.showMembers();
