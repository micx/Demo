...
//        }
    ...
    private void showMembers() throws Exception {
        FileWriter fw = new FileWriter("/Users/micx/Projects/canzhuo/brand");
        for(int i=1; i<=16; ++i) {
            fw.write(request("http://admin.canzhuowang.cn/admin.php/brand/admin?Brand_page="+i));
    ...
    public static void main(String[] args) throws Exception {
        BrandReport brand = new BrandReport();
        brand.showMembers();
